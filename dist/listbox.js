...
export function ListboxMulti({ selectedKeys, ...props }) {
  return /* @__PURE__ */ React.createElement(ListboxImpl, { selectedKeys, selectionMode: "multiple", ...props });
}
export function ListboxSingle({ selectedKey, ...props }) {
  return /* @__PURE__ */ React.createElement(ListboxImpl, { selectedKeys: selectedKey == null ? [] : [selectedKey], selectionMode: "single", ...props });
}
function ListboxImpl({ selectedKeys, selectionMode, children, items }) {
  ...
  return /* @__PURE__ */ React.createElement("ul", { ...mergeProps(listBoxProps, { ref }) }, children);
}
